...
const NormalSlip = () => {
  ...
  // ================= PASSPORT VALIDITY =================
  const hasValidPassportYears = (issueDate, expiryDate) => {
    const issue = new Date(issueDate);
    const expiry = new Date(expiryDate);

    const diffYears =
      (expiry.getTime() - issue.getTime()) / (1000 * 60 * 60 * 24 * 365);
  ...
  const validateForm = () => {
    ...
    // 🔞 DOB AGE CHECK
    if (formData.dob && !isAtLeast18(formData.dob)) {
